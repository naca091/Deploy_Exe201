...
const MenuCard = ({ menu, onSeeMenu }) => (
  <Card
    ...
    cover={
      <div className="aspect-square overflow-hidden" style={{ height: '200px' }}>
        <img
          alt={menu.name}
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        {menu.ingredients && (
          <div>
            <Text strong className="text-lg">Ingredients</Text>
        ...
        {menu.instructions && (
          <div>
            <Text strong className="text-lg">Instructions</Text>
...
const Homepage = () => {
  ...
  const bannerImages = Array(5).fill('/api/placeholder/1200/400');
