...
const MenuForm = ({ visible, onCancel, onSuccess, initialValues }) => {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      formData.append("image", values.image.file.originFileObj); // Key phải là "image"
      ...
      console.log("Upload response:", uploadResponse.data); // Log phản hồi từ server
  
      // Lưu đường dẫn file vào trường image
      values.image = uploadResponse.data.filePath;
