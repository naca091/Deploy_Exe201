...
const roleSchema = new mongoose.Schema({
  ...
  permissions: [{
    type: String,
    enum: ['create_menu', 'edit_menu', 'delete_menu', 'manage_users', 'view_analytics']
  }]
}, { timestamps: true });
...
// Ingredient Schema - Thêm categories và nutritional info
const ingredientSchema = new mongoose.Schema({
  ...
  category: {
    type: String,
    enum: ['meat', 'vegetable', 'fruit', 'dairy', 'grain', 'spice', 'other'],
    required: true
  },
  nutritionalInfo: {
    calories: Number,
