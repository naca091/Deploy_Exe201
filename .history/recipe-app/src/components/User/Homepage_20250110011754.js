...
import MenuDetailModal from './MenuDetailModal'; // Đảm bảo đường dẫn đúng đến component MenuDetailModal  
...
const Homepage = () => {  
    ...
    const userXu = user ? user.xu : 0; // Lấy số xu của người dùng từ localStorage  
