            ...
            <div className="min-h-screen flex justify-center items-center bg-gray-100">
                <Card className="w-1/2">
                    <div className="text-center mb-6">
                        ...
                        <p className="text-gray-500">Coins: {user.coins}</p>
                        <p className="text-gray-500">Role: {user.role?.name || 'N/A'}</p>
                        <p className="text-gray-500">Address: {user.address}</p>
                        <p className="text-gray-500">Phone: {user.phone}</p>
                        <p className="text-gray-500">Last Login: {user.lastLogin || 'N/A'}</p>
                    </div>
