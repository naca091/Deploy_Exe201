...
const MenuDetailModal = ({ menu, user, visible, onClose, userCoins, onPurchaseMenu }) => {
    ...
    if (user.coins >= menu.unlockPrice) {
      Modal.confirm({
        ...
        onOk: async () => {
          ...
          // Sau khi thành công, bạn có thể cập nhật trạng thái menu và user
        },
      });
    } else {
      Modal.error({
        title: 'Insufficient Coins',
        content: 'You do not have enough coins to unlock this menu.',
      });
    }
  };
