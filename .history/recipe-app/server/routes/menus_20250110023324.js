...
router.post('/purchase/:menuId', async (req, res) => {  
  console.log('Received request to unlock menu:', req.params.menuId);  

  const menuId = req.params.menuId;  
  const userId = req.user.id; // Giả định bạn đã xác thực người dùng và có userId trong req.user  
  ...
  try {  
      ...
      // Trừ xu và thêm ID người dùng vào purchasedBy  
