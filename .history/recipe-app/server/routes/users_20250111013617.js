...
router.post('/login', async (req, res) => {
    ...
    try {
      ...
      // Tạo token (có thể sử dụng thư viện như jsonwebtoken hoặc session management)
      const token = `token-${user._id}-${Date.now()}`; // Đây chỉ là ví dụ, cần thay thế bằng JWT hoặc phương pháp bảo mật khác
